...
const ZOMBIE_BASE = {
  ...
  burger:    { hp: 75,  speed: 50, damage: 10, reward: 20, skin: 'burger'    },
  bird:      { hp: 30,  speed: 70, damage: 8,  reward: 15, skin: 'bird', flying: true },
};
...
const ANIM_DEFS = {
  zombie: { default: { frames: 6, fps: 8 }, bird: { frames: 2, fps: 8 } },
