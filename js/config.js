...
const ZOMBIE_BASE = {
  normal:        { hp: 30, speed: 17, damage: 10, reward: 20 },
  normal_cap:    { hp: 45, speed: 19, damage: 13, reward: 25 },
  normal_helmet: { hp: 60, speed: 21, damage: 18, reward: 30 },
  alt:           { hp: 35, speed: 17, damage: 11, reward: 22 },
  alt_helmet:    { hp: 65, speed: 20, damage: 19, reward: 32 },
  alt_cap:       { hp: 50, speed: 19, damage: 15, reward: 27 },
};
